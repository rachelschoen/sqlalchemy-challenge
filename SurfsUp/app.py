...
def tobs():
    ...
    # Perform a query to get the dates and temperature observations of the
    ...
    # Return a JSON list of temperature data of previous year for 
...
def start_end(start, end):
    ...
    # Perform a query to get TMIN, TAVG, and TMAX for all the dates from
    # start date to end date, taken as parameters from the URL.
